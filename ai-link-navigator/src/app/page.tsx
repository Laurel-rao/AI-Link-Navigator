      ...
      <div className="relative z-10 max-w-7xl mx-auto p-6 md:p-12">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-4">
              ...
              <div className="text-sm text-slate-300">
                欢迎回来，<span className="gradient-text-blue font-semibold">{session.user.username}</span>
              </div>
            </div>
        ...
        <header className="mb-16 text-center relative">
          ...
          <div className="relative max-w-4xl mx-auto">
            <p className="text-slate-300 text-xl md:text-2xl leading-relaxed glassmorphism-card rounded-2xl p-6 backdrop-blur-sm">
        ...
        <div className="mb-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="glassmorphism-card glassmorphism-hover rounded-2xl p-6 text-center">
            <div className="text-3xl font-bold gradient-text-blue mb-2">AI工具</div>
            <div className="text-slate-400">智能助手集合</div>
          </div>
          <div className="glassmorphism-card glassmorphism-hover rounded-2xl p-6 text-center">
            <div className="text-3xl font-bold gradient-text-purple mb-2">资源库</div>
            <div className="text-slate-400">精选资源导航</div>
          </div>
          <div className="glassmorphism-card glassmorphism-hover rounded-2xl p-6 text-center">
            <div className="text-3xl font-bold gradient-text mb-2">实时更新</div>
            <div className="text-slate-400">持续优化体验</div>
          </div>
        </div>
